...
renderValueBox({
  valueBox(
    ...
    icon  = "fa-dog",
    color = "#A9A9A9"   # or any color you like
  )
})
```
...
### 🔍 Select Traits to Explore Correlation {data-height=6}
```{r}
fluidRow(
  column(
    width = 6,
...
### 📉 Scatterplot: Selected Traits {data-height=49}
```{r}
renderPlotly({
