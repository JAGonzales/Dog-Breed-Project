...
<style>
  ...
  .shiny-valuebox .value-box {
    height: 15vh;                 # 5 boxes ≈ full column height
    display: flex;
...
tags$div(
  ...
  ",
  tags$img(
    src = "https://images.rawpixel.com/image_social_landscape/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvbHIvczY5LXRlZDQyNDQtdG9uZy1qai1hZS1sLmpwZw.jpg",
    style = "
      width: 100%;
      height: auto;
      border-radius: 12px;
...
datatable(
  trait_desc_clean,
  colnames = c("Trait", "Score_1", "Score_5", "Description"),
  options = list(pageLength = 5, lengthMenu = c(5, 10, 14)),
  ...
  datatable(
    ...
    formatStyle(
      ...
      backgroundColor = styleInterval(
        cuts = c(-0.5, 0, 0.5),
        values = c("#2166AC", "#F7F7F7", "#F7F7F7", "#EE6363")
      )
    )
})
```
